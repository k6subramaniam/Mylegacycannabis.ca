...
const CATEGORY_META: Record<string, RouteMeta> = {
  ...
  "pre-rolls": {
    ...
    description: "Shop pre-rolled joints and blunts at My Legacy Cannabis.",
  },
  edibles: {
    title:
      "Cannabis Edibles \u2014 Gummies, Chocolates & More | My Legacy Cannabis",
    description: "Shop cannabis edibles at My Legacy Cannabis.",
  },
  vapes: {
    title: "Vape Cartridges & Pens \u2014 Cannabis Vapes | My Legacy Cannabis",
    description:
      "Shop cannabis vape cartridges, disposable pens, and 510 carts.",
  },
  concentrates: {
    title:
      "Cannabis Concentrates \u2014 Shatter, Wax & Hash | My Legacy Cannabis",
    description: "Shop cannabis concentrates at My Legacy Cannabis.",
  },
  "ounce-deals": {
    title: "Ounce Deals \u2014 Bulk Cannabis Savings | My Legacy Cannabis",
    description: "Save big with ounce deals at My Legacy Cannabis.",
  },
  "shake-n-bake": {
    title: "Shake & Bake \u2014 Budget Cannabis | My Legacy Cannabis",
    description: "Shop affordable shake and trim at My Legacy Cannabis.",
  },
  accessories: {
    title:
      "Cannabis Accessories \u2014 Papers, Pipes & Grinders | My Legacy Cannabis",
    description: "Shop cannabis accessories at My Legacy Cannabis.",
  },
};
...
async function buildProductJsonLd(product: any, slug: string) {
  ...
  const jsonLd: any = {
    ...
    image: product.imageUrl
      ...
      : `${SITE_URL}/logo.webp`,
    description:
      product.description || `Shop ${product.name} at My Legacy Cannabis.`,
...
export async function injectSeoMeta(
  ...
  if (meta) {
    ...
    // 10) Inject JSON-LD
    if (meta.jsonLd) {
      result = result.replace(/<\/head>/i, `${meta.jsonLd}\n</head>`);
    }
  } else {
