...
const DISPOSABLE_DOMAINS = new Set([
  ...
  "tempmail.com", "temp-mail.org", "throwaway.email", "tempinbox.com",
  "yopmail.com", "yopmail.fr", "yopmail.net", "sharklasers.com",
  "guerrillamailblock.com", "grr.la", "dispostable.com", "maildrop.cc",
  "mailnesia.com", "mailexpire.com", "trashmail.com", "trashmail.net",
  "trashmail.me", "fakeinbox.com", "harakirimail.com", "33mail.com",
  "discard.email", "discardmail.com", "discardmail.de", "mytemp.email",
  "tmpmail.net", "tmpmail.org", "getnada.com", "nada.email",
  "mohmal.com", "emailondeck.com", "10minutemail.com", "10minutemail.net",
  "20minutemail.com", "minutemail.com", "tempr.email", "burnermail.io",
  "tmail.com", "tmailinator.com", "mailsac.com", "mailcatch.com",
  "spamgourmet.com", "inboxalias.com", "mailtothis.com", "incognitomail.com",
  "disposableemailaddresses.emailmiser.com", "jetable.org", "trash-mail.at",
  "spambox.us", "spamfree24.org", "mailnull.com", "mailscrap.com",
  "crazymailing.com", "deadaddress.com", "nowmymail.com", "safetymail.info",
  "binkmail.com", "spaml.com", "emailisvalid.com", "trashymail.com",
  "armyspy.com", "cuvox.de", "dayrep.com", "einrot.com", "fleckens.hu",
  "gustr.com", "jourrapide.com", "rhyta.com", "superrito.com", "teleworm.us",
  "mailforspam.com", "spamcero.com", "spamhereplease.com",
  // More recent providers
  "tempmailaddress.com", "emailfake.com", "fakemailgenerator.com",
  "tempail.com", "throwaway.email", "bugmenot.com",
  "filzmail.com", "mytrashmail.com", "trashymail.net",
  "mailcatch.com", "reallymymail.com", "mt2015.com",
  "thankyou2010.com", "trash2009.com", "trashdevil.com",
  "trashdevil.de", "trashemail.de", "upliftnow.com",
  "wegwerfmail.de", "wegwerfmail.net", "wegwerfmail.org",
  "wh4f.org", "veryreallyyemail.com",
]);
...
export function validateCanadianPhone(phone: string): {
  ...
  if (!normalized) {
    return { valid: false, normalized: null, error: "Phone number must be 10 digits" };
  }
  ...
  if (!CANADIAN_AREA_CODES.has(areaCode)) {
    return { valid: false, normalized, areaCode, error: "Invalid Canadian area code. Please use a valid Canadian phone number." };
  }
  ...
  if (exchange.startsWith("0") || exchange.startsWith("1")) {
    return { valid: false, normalized, areaCode, error: "Invalid phone number format" };
  }

  // Check known VOIP area codes
  if (VOIP_AREA_CODES.has(areaCode)) {
    return { valid: false, normalized, areaCode, error: "VOIP / virtual phone numbers are not accepted. Please use a mobile number from a Canadian carrier." };
  }
...
export function validateRegistrationInput(data: {
  ...
  if (!data.firstName?.trim() || data.firstName.trim().length < 2) {
    return { valid: false, field: "firstName", error: "First name must be at least 2 characters" };
  }

  // Last name
  if (!data.lastName?.trim() || data.lastName.trim().length < 2) {
    return { valid: false, field: "lastName", error: "Last name must be at least 2 characters" };
  }

  // Email
  if (!isValidEmailFormat(data.email)) {
    return { valid: false, field: "email", error: "Please enter a valid email address" };
  }
  if (isDisposableEmail(data.email)) {
    return { valid: false, field: "email", error: "Temporary or disposable email addresses are not accepted. Please use a permanent email address." };
  }
