...
import { reserveUniqueCentAmount, findOrderByCentAmount } from '../../centMatching';
...
describe('Cent Matching Logic', () => {
  ...
  describe('reserveUniqueCentAmount', () => {
    it('reserves 1 cent if none used', async () => {
      ...
      const result = await reserveUniqueCentAmount(120.00, 1);
    ...
    it('reserves 2 cents if 1 is used', async () => {
      ...
      const result = await reserveUniqueCentAmount(120.00, 2);
    ...
    it('finds first available gap', async () => {
      ...
      const result = await reserveUniqueCentAmount(120.00, 3);
    ...
    it('handles initial amounts that already have cents', async () => {
      ...
      const result = await reserveUniqueCentAmount(120.50, 4);
    ...
    it('rolls over to next dollar if 99 offsets are used', async () => {
      ...
      const result = await reserveUniqueCentAmount(120.00, 5);
