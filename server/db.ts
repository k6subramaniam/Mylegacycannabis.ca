...
export async function initializeDatabase(): Promise<void> {
  ...
  const enumDefs = [
    ...
    { name: "verification_status", values: "'pending','approved','rejected'" },
    {
      name: "rewards_type",
      values:
        "'earned','redeemed','bonus','deducted','admin_add','admin_deduct'",
    },
  ];
  for (const e of enumDefs) {
    await _sql!.unsafe(
      `DO $$ BEGIN CREATE TYPE ${e.name} AS ENUM (${e.values}); EXCEPTION WHEN duplicate_object THEN null; END $$`
    );
  }
  ...
  for (const val of ["ounce-deals", "shake-n-bake"]) {
    await _sql!.unsafe(
      `DO $$ BEGIN ALTER TYPE product_category ADD VALUE IF NOT EXISTS '${val}'; EXCEPTION WHEN duplicate_object THEN null; END $$`
    );
  }

  // Add partially_refunded to payment_status enum (safe for existing DBs)
  await _sql!.unsafe(
    `DO $$ BEGIN ALTER TYPE payment_status ADD VALUE IF NOT EXISTS 'partially_refunded' BEFORE 'refunded'; EXCEPTION WHEN duplicate_object THEN null; END $$`
  );

  // Add subcategory and grade columns if missing
  await _sql!.unsafe(
    `DO $$ BEGIN ALTER TABLE products ADD COLUMN IF NOT EXISTS subcategory VARCHAR(100); EXCEPTION WHEN duplicate_column THEN null; END $$`
  );
  await _sql!.unsafe(
    `DO $$ BEGIN ALTER TABLE products ADD COLUMN IF NOT EXISTS grade VARCHAR(20); EXCEPTION WHEN duplicate_column THEN null; END $$`
  );
  ...
  await _sql!.unsafe(
    `DO $$ BEGIN CREATE TYPE coupon_type AS ENUM ('percentage','fixed_amount','free_shipping'); EXCEPTION WHEN duplicate_object THEN null; END $$`
  );

  // ─── Alter rewards_type enum to add new values ───
  for (const val of ["birthday", "referral", "review"]) {
    await _sql!.unsafe(
      `DO $$ BEGIN ALTER TYPE rewards_type ADD VALUE IF NOT EXISTS '${val}'; EXCEPTION WHEN duplicate_object THEN null; END $$`
    );
  }
  ...
  await _sql!.unsafe(
    `DO $$ BEGIN CREATE TYPE behavior_event_type AS ENUM ('page_view','product_view','category_view','add_to_cart','remove_from_cart','search','click','checkout_start','checkout_complete','review_submit','wishlist_add'); EXCEPTION WHEN duplicate_object THEN null; END $$`
  );
  await _sql!`
  ...
  END $$`;
  await _sql!.unsafe(
    `CREATE INDEX IF NOT EXISTS idx_user_behavior_province ON user_behavior(province_code) WHERE province_code IS NOT NULL`
  );
  await _sql!.unsafe(
    `CREATE INDEX IF NOT EXISTS idx_user_behavior_city ON user_behavior(city) WHERE city IS NOT NULL`
  );
  ...
  `;
  await _sql!.unsafe(
    `CREATE INDEX IF NOT EXISTS idx_cent_amount ON cent_reservations(final_amount) WHERE status = 'reserved'`
  );
  ...
  if (existingUsers[0].cnt === 0) {
    ...
    console.log(
      `[DB] Database has ${existingUsers[0].cnt} users — skipping seed`
    );
  }
...
async function seedDefaultSettings(db: PostgresJsDatabase<typeof schema>) {
  const defaults: { key: string; value: string }[] = [
    ...
    {
      key: "store_hours_note",
      value:
        "Orders placed outside business hours will be processed on the next business day.",
    },
  ];
  for (const d of defaults) {
    const existing = await db
      ...
      .where(eq(schema.siteSettings.key, d.key))
      .limit(1);
...
const DEFAULT_LOCATIONS = [
  {
    ...
    hours: "Open 24/7",
    mapUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2889.5!2d-79.6!3d43.59!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDPCsDM1JzI0LjAiTiA3OcKwMzYnMDAuMCJX!5e0!3m2!1sen!2sca!4v1",
    directionsUrl:
      "https://www.google.com/maps/dir/?api=1&destination=255+Dundas+St+W+Mississauga+ON",
    lat: "43.590000",
    lng: "-79.600000",
    sortOrder: 0,
  },
  {
    ...
    hours: "Open 24/7",
    mapUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2906.5!2d-79.87!3d43.25!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2z!5e0!3m2!1sen!2sca!4v1",
    directionsUrl:
      "https://www.google.com/maps/dir/?api=1&destination=123+King+St+E+Hamilton+ON",
    lat: "43.250000",
    lng: "-79.870000",
    sortOrder: 1,
  },
  {
    ...
    hours: "Open 24/7",
    mapUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2887.5!2d-79.4!3d43.65!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2z!5e0!3m2!1sen!2sca!4v1",
    directionsUrl:
      "https://www.google.com/maps/dir/?api=1&destination=456+Queen+St+W+Toronto+ON",
    lat: "43.650000",
    lng: "-79.400000",
    sortOrder: 2,
  },
  {
    ...
    hours: "Open 24/7",
    mapUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2887.5!2d-79.41!3d43.65!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2z!5e0!3m2!1sen!2sca!4v1",
    directionsUrl:
      "https://www.google.com/maps/dir/?api=1&destination=789+Dundas+St+W+Toronto+ON",
    lat: "43.650000",
    lng: "-79.410000",
    sortOrder: 3,
  },
  {
    ...
    hours: "Open 24/7",
    mapUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2800.5!2d-75.73!3d45.35!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2z!5e0!3m2!1sen!2sca!4v1",
    directionsUrl:
      "https://www.google.com/maps/dir/?api=1&destination=1642+Merivale+Rd+Ottawa+ON",
    lat: "45.350000",
    lng: "-75.730000",
    sortOrder: 4,
  },
 ...
 */
async function fixProductCategoriesAndGrades(
  ...
  if (shakeProducts.length > 0) {
    ...
    console.log(
      `[DB Fix] Re-categorized ${shakeProducts.length} Shake n Bake products`
    );
  }
  ...
  if (ounceProducts.length > 0) {
    ...
    console.log(
      `[DB Fix] Re-categorized ${ounceProducts.length} Ounce Deal products`
    );
  }
  ...
  if (ounceBySlug.length > 0) {
    ...
    console.log(
      `[DB Fix] Re-categorized ${ounceBySlug.length} Ounce Deal products by slug`
    );
  }
  ...
  if (flowerNoSub.length > 0) {
    ...
    console.log(
      `[DB Fix] Set subcategory for ${flowerNoSub.length} flower products`
    );
  }
  ...
  if (preRollNoSub.length > 0) {
    ...
    console.log(
      `[DB Fix] Set subcategory for ${preRollNoSub.length} pre-roll products`
    );
  }
  ...
  if (ounceNoSub.length > 0) {
    ...
    console.log(
      `[DB Fix] Set subcategory for ${ounceNoSub.length} ounce-deal products`
    );
  }
  ...
  if (shakeNoSub.length > 0) {
    ...
    console.log(
      `[DB Fix] Set subcategory for ${shakeNoSub.length} shake-n-bake products`
    );
  }
  ...
  if (gradeFromFlavor.length > 0) {
    ...
    console.log(
      `[DB Fix] Populated grade from flavor for ${gradeFromFlavor.length} products`
    );
  }
...
export async function getActiveLocations() {
  if (!USE_PERSISTENT_DB)
    return DEFAULT_LOCATIONS.map((loc, i) => ({
      id: i + 1,
      ...loc,
      isActive: true,
      createdAt: new Date(),
  ...
  return getDb()
    ...
    .orderBy(schema.storeLocations.sortOrder);
}
...
export async function getLocationById(id: number) {
  if (!USE_PERSISTENT_DB) {
    const idx = id - 1;
    if (idx >= 0 && idx < DEFAULT_LOCATIONS.length)
      return {
        id,
...
async function syncEmailTemplates(db: PostgresJsDatabase<typeof schema>) {
  ...
  if (inserted > 0 || updated > 0) {
    console.log(
      `[DB] Synced email templates: ${inserted} added, ${updated} upgraded (${total} total)`
    );
  } else {
...
export async function upsertUser(userData: schema.InsertUser): Promise<void> {
  ...
  if (existing.length > 0) {
    ...
    if (userData.authMethod !== undefined)
      updates.authMethod = userData.authMethod;
    if (userData.rewardPoints !== undefined)
      updates.rewardPoints = userData.rewardPoints;
    if (userData.birthday !== undefined) updates.birthday = userData.birthday;
    if (userData.idVerified !== undefined)
      updates.idVerified = userData.idVerified;
...
export async function getUserOrders(userId: number) {
  ...
  if (user.email)
    conditions.push(
      sql`LOWER(${schema.orders.guestEmail}) = LOWER(${user.email})`
    );
...
export async function createVerificationCode(data: {
  ...
  await db
    ...
    .where(
      and(
        eq(schema.verificationCodes.identifier, data.identifier),
        eq(schema.verificationCodes.type, data.type),
        eq(schema.verificationCodes.verified, false)
      )
    );
  const result = await db
    .insert(schema.verificationCodes)
    .values(data)
    .returning({ id: schema.verificationCodes.id });
  return result[0].id;
}
...
export async function verifyCode(
  ...
  if (record.code !== code) {
    ...
    return {
      valid: false,
      reason: `Incorrect code. ${4 - record.attempts} attempts remaining.`,
    };
  }
  await db
    .update(schema.verificationCodes)
...
export async function getAllProducts(opts?: {
  ...
  const conditions = [];
  if (opts?.category)
    conditions.push(eq(schema.products.category, opts.category as any));
  if (opts?.activeOnly) conditions.push(eq(schema.products.isActive, true));
  if (opts?.search) {
    const q = `%${opts.search}%`;
    conditions.push(
      or(ilike(schema.products.name, q), ilike(schema.products.slug, q))
    );
  }
...
export async function countFeaturedProducts(): Promise<number> {
  if (!USE_PERSISTENT_DB)
    return _products.filter(p => (p as any).featured).length;
...
export async function getAllOrders(opts?: {
  ...
  const conditions = [];
  if (opts?.status)
    conditions.push(eq(schema.orders.status, opts.status as any));
  if (opts?.search) {
    const q = `%${opts.search}%`;
    conditions.push(
      or(
        ilike(schema.orders.orderNumber, q),
        ilike(schema.orders.guestEmail, q),
        ilike(schema.orders.guestName, q)
      )
    );
  }
  if (opts?.dateFrom)
    conditions.push(gte(schema.orders.createdAt, opts.dateFrom));
...
export async function createOrderItems(
  items: schema.InsertOrderItem[]
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_createOrderItems(items);
    return;
  }
...
export async function updateOrder(
  id: number,
  data: Partial<schema.InsertOrder>
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_updateOrder(id, data);
    return;
  }
  await getDb()
...
export async function getAllVerifications(opts?: {
  ...
  const conditions = [];
  if (opts?.status)
    conditions.push(eq(schema.idVerifications.status, opts.status as any));
  if (opts?.email)
    conditions.push(
      sql`LOWER(${schema.idVerifications.guestEmail}) = LOWER(${opts.email})`
    );
  const where = conditions.length > 0 ? and(...conditions) : undefined;
  const data = await db
    .select()
    .from(schema.idVerifications)
    .where(where)
    .orderBy(desc(schema.idVerifications.createdAt))
    .offset(offset)
    .limit(limit);
  const totalResult = await db
    .select({ cnt: count() })
...
export async function getVerificationById(id: number) {
  ...
  const rows = await getDb()
    .select()
    .from(schema.idVerifications)
    .where(eq(schema.idVerifications.id, id))
    .limit(1);
  return rows[0];
}

export async function createVerification(
  data: schema.InsertIdVerification
): Promise<number> {
  if (!USE_PERSISTENT_DB) return _mem_createVerification(data);
  const result = await getDb()
    .insert(schema.idVerifications)
    .values(data)
    .returning({ id: schema.idVerifications.id });
  return result[0].id;
}

export async function updateVerification(
  id: number,
  data: Partial<schema.InsertIdVerification>
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_updateVerification(id, data);
    return;
  }
  await getDb()
    .update(schema.idVerifications)
    .set({ ...data, updatedAt: new Date() } as any)
    .where(eq(schema.idVerifications.id, id));
}
...
export async function getAllShippingZones() {
  ...
  return getDb()
    ...
    .orderBy(schema.shippingZones.id);
}

export async function updateShippingZone(
  id: number,
  data: Partial<schema.InsertShippingZone>
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_updateShippingZone(id, data);
    return;
  }
  await getDb()
...
export async function createShippingZone(
  data: schema.InsertShippingZone
): Promise<number> {
...
export async function getAllEmailTemplates() {
  ...
  return getDb()
    .select()
    .from(schema.emailTemplates)
    .orderBy(schema.emailTemplates.slug);
}
...
export async function updateEmailTemplate(
  id: number,
  data: Partial<schema.InsertEmailTemplate>
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_updateEmailTemplate(id, data);
    return;
  }
  await getDb()
    .update(schema.emailTemplates)
...
export async function createEmailTemplate(
  data: schema.InsertEmailTemplate
): Promise<number> {
...
export async function getAllSiteSettings(): Promise<Record<string, string>> {
  ...
  for (const r of rows) {
    ...
    _settingsCache.set(r.key, r.value);
  }
  return result;
}
...
export async function logAdminActivity(
  data: schema.InsertAdminActivityLog
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_logAdminActivity(data);
    return;
  }
...
// ─── REWARDS HISTORY ───
export async function addRewardsHistory(
  data: schema.InsertRewardsHistory
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_addRewardsHistory(data);
    return;
  }
...
export async function getRewardsHistoryByUser(userId: number) {
  ...
  return getDb()
    .select()
    .from(schema.rewardsHistory)
    .where(eq(schema.rewardsHistory.userId, userId))
    .orderBy(desc(schema.rewardsHistory.createdAt));
}
...
export async function getCouponByCode(code: string) {
  ...
  const rows = await getDb()
    .select()
    .from(schema.coupons)
    .where(sql`UPPER(${schema.coupons.code}) = UPPER(${code})`)
    .limit(1);
  return rows[0];
}
...
export async function updateCoupon(
  id: number,
  data: Partial<schema.InsertCoupon>
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_updateCoupon(id, data);
    return;
  }
  await getDb()
...
export async function deleteCoupon(id: number): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_deleteCoupon(id);
    return;
  }
  await getDb().delete(schema.coupons).where(eq(schema.coupons.id, id));
}

export async function getCouponUsageByEmail(
  couponId: number,
  email: string
): Promise<number> {
  ...
  const result = await getDb()
    ...
    .where(
      and(
        eq(schema.couponUsage.couponId, couponId),
        sql`LOWER(${schema.couponUsage.email}) = LOWER(${email})`
      )
    );
  return result[0].cnt;
}
...
export async function recordCouponUsage(
  data: schema.InsertCouponUsage
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_recordCouponUsage(data);
    return;
  }
...
export async function validateCoupon(
  ...
  subtotal: number,
  email: string
): Promise<{ valid: boolean; coupon?: any; discount: number; error?: string }> {
...
export async function getReferralCodeByCode(code: string) {
  ...
  const rows = await getDb()
    .select()
    .from(schema.referralCodes)
    .where(sql`UPPER(${schema.referralCodes.code}) = UPPER(${code})`)
    .limit(1);
  return rows[0];
}

export async function createReferralCode(
  data: schema.InsertReferralCode
): Promise<number> {
...
export async function trackReferral(
  data: schema.InsertReferralTracking
): Promise<number> {
  if (!USE_PERSISTENT_DB) return _mem_trackReferral(data);
  const result = await getDb()
    .insert(schema.referralTracking)
    .values(data)
    .returning({ id: schema.referralTracking.id });
  return result[0].id;
}
...
export async function getReferralTracking(referrerId: number) {
  ...
  return getDb()
    .select()
    .from(schema.referralTracking)
    .where(eq(schema.referralTracking.referrerId, referrerId))
    .orderBy(desc(schema.referralTracking.createdAt));
}

// ─── PRODUCT REVIEW HELPERS ───
export async function createProductReview(
  data: schema.InsertProductReview
): Promise<number> {
...
export async function updateReviewPointsAwarded(id: number): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_updateReviewPointsAwarded(id);
    return;
  }
  await getDb()
    .update(schema.productReviews)
...
export async function updateProductReview(
  id: number,
  data: Partial<schema.InsertProductReview>
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_updateProductReview(id, data);
    return;
  }
  await getDb()
    .update(schema.productReviews)
...
export async function awardOrderPoints(
  orderId: number
): Promise<{ points: number; userId?: number } | null> {
    ...
    const existing = await getDb()
      ...
      .where(
        and(
          ...
          eq(schema.rewardsHistory.type, "earned")
        )
      )
      .limit(1);
    if (existing.length > 0) return null; // already awarded
  } else {
    const existing = _rewardsHistory.find(
      (r: any) => r.orderId === orderId && r.type === "earned"
    );
 ...
 */
export async function clawbackOrderPoints(
  orderId: number
): Promise<{ points: number; userId?: number } | null> {
  const order = await getOrderById(orderId);
  if (!order) return null;
  ...
  if (USE_PERSISTENT_DB) {
    const existing = await getDb()
      ...
      .where(
        and(
          eq(schema.rewardsHistory.orderId, orderId),
          eq(schema.rewardsHistory.type, "redeemed")
        )
      )
      .limit(1);
    // We use 'redeemed' type with negative description as clawback marker
    const clawbacks = await getDb()
      .select()
      .from(schema.rewardsHistory)
      .where(
        and(
    ...
    const existing = _rewardsHistory.find(
      (r: any) => r.orderId === orderId && r.description?.includes("clawback")
    );
    if (existing) return null;
  }
  ...
  await addRewardsHistory({
    ...
    points: -points,
    type: "redeemed",
    description: `Points clawback for refunded order ${order.orderNumber}`,
    orderId,
  } as any);
 ...
 */
export async function getPaymentRecordByOrderId(
  orderId: number
): Promise<any | null> {
  if (!USE_PERSISTENT_DB) {
    return (
      _mem_paymentRecords.find((p: any) => p.matchedOrderId === orderId) || null
    );
  }
  const rows = await getDb()
    .select()
...
export async function isOrderAlreadyMatched(orderId: number): Promise<boolean> {
  if (!USE_PERSISTENT_DB) {
    return _mem_paymentRecords.some(
      (p: any) =>
        p.matchedOrderId === orderId &&
        (p.status === "auto_matched" || p.status === "manual_matched")
    );
  }
  const rows = await getDb()
    ...
    .where(
      and(
        ...
        or(
          eq(schema.paymentRecords.status, "auto_matched" as any),
          eq(schema.paymentRecords.status, "manual_matched" as any)
        )
      )
    )
    .limit(1);
  ...
  if (USE_PERSISTENT_DB) {
    ...
    for (const user of eligibleUsers) {
      ...
      await addRewardsHistory({
        ...
        description: `Happy Birthday! +${BIRTHDAY_BONUS} bonus points`,
      } as any);
      awarded++;
    }
  } else {
...
export async function getDashboardStats() {
  ...
  const [revResult] = await db
    .select({
      total: sql<number>`COALESCE(SUM(CAST(${schema.orders.total} AS NUMERIC)), 0)`,
    })
    .from(schema.orders)
    .where(
      or(
        eq(schema.orders.paymentStatus, "confirmed"),
        eq(schema.orders.paymentStatus, "received")
      )
    );
  const [pendingV] = await db
    .select({ cnt: count() })
    .from(schema.idVerifications)
    .where(eq(schema.idVerifications.status, "pending"));
...
export async function getOrderStats(days = 30) {
  ...
  const rows = await db
    ...
    .from(schema.orders)
    .where(gte(schema.orders.createdAt, fromDate))
...
export async function createPaymentRecord(
  data: schema.InsertPaymentRecord
): Promise<number> {
...
export async function getPaymentRecordByEmailId(emailId: string) {
  if (!USE_PERSISTENT_DB)
    return _mem_paymentRecords.find((p: any) => p.emailId === emailId) || null;
  const rows = await getDb()
    .select()
    .from(schema.paymentRecords)
    .where(eq(schema.paymentRecords.emailId, emailId))
    .limit(1);
  return rows[0] || null;
}

export async function getAllPaymentRecords(opts?: {
  page?: number;
  limit?: number;
  status?: string;
}) {
  ...
  if (opts?.status)
    conditions.push(eq(schema.paymentRecords.status, opts.status as any));
  const where = conditions.length > 0 ? and(...conditions) : undefined;
  const data = await db
    .select()
    .from(schema.paymentRecords)
...
export async function updatePaymentRecord(
  id: number,
  data: Partial<schema.InsertPaymentRecord>
): Promise<void> {
  if (!USE_PERSISTENT_DB) {
    _mem_updatePaymentRecord(id, data);
    return;
  }
  await getDb()
...
export async function getUnmatchedPaymentRecords() {
  if (!USE_PERSISTENT_DB)
    return _mem_paymentRecords.filter((p: any) => p.status === "unmatched");
  return getDb()
    .select()
    .from(schema.paymentRecords)
...
export async function exportAllPaymentRecords() {
  if (!USE_PERSISTENT_DB) {
    return [..._mem_paymentRecords].sort(
...
export async function getReservedCentOffsets(
  baseDollars: string
): Promise<number[]> {
  if (!USE_PERSISTENT_DB) return [];
  const rows = await getDb()
    .select({ centOffset: schema.centReservations.centOffset })
...
export async function createCentReservation(
  data: schema.InsertCentReservation
): Promise<number> {
  if (!USE_PERSISTENT_DB) return 0;
  const result = await getDb()
    .insert(schema.centReservations)
    .values(data)
    .returning({ id: schema.centReservations.id });
  return result[0].id;
}

/** Find a pending cent reservation by exact final amount (for matching) */
export async function findCentReservationByAmount(
  amount: string
): Promise<schema.CentReservation[]> {
  if (!USE_PERSISTENT_DB) return [];
  return getDb()
    .select()
    .from(schema.centReservations)
...
export async function markCentReservationMatched(
  orderId: number
): Promise<void> {
  if (!USE_PERSISTENT_DB) return;
  await getDb()
    .update(schema.centReservations)
    .set({ status: "matched" })
...
export async function createUnmatchedPayment(
  data: schema.InsertUnmatchedPayment
): Promise<number> {
  if (!USE_PERSISTENT_DB) return 0;
  const result = await getDb()
    .insert(schema.unmatchedPayments)
    .values(data)
    .returning({ id: schema.unmatchedPayments.id });
  return result[0].id;
}
...
export async function updateUnmatchedPayment(
  id: number,
  data: Partial<schema.InsertUnmatchedPayment>
): Promise<void> {
  if (!USE_PERSISTENT_DB) return;
  await getDb()
    .update(schema.unmatchedPayments)
    .set(data as any)
    .where(eq(schema.unmatchedPayments.id, id));
}
...
export async function fileStorePut(
  key: string,
  data: Buffer,
  contentType: string
): Promise<void> {
  ...
  console.log(
    `[FileStore] Saved: ${key} (${(sizeBytes / 1024).toFixed(1)} KB)`
  );
}
...
export async function fileStoreGetAll(): Promise<
  Array<{
    key: string;
    data: string;
    contentType: string;
...
export async function recordBehaviorEvent(
  data: schema.InsertUserBehavior
): Promise<void> {
  if (!USE_PERSISTENT_DB) return;
...
export async function recordBehaviorEvents(
  events: schema.InsertUserBehavior[]
): Promise<void> {
  if (!USE_PERSISTENT_DB) return;
...
export async function getUserBehaviorSummary(userId: number): Promise<{
  ...
  const [pvResult] = await db
    .select({ cnt: count() })
    .from(schema.userBehavior)
    .where(
      and(
        eq(schema.userBehavior.userId, userId),
        eq(schema.userBehavior.eventType, "page_view")
      )
    );
  ...
  const [prodResult] = await db
    ...
    .where(
      and(
        eq(schema.userBehavior.userId, userId),
        eq(schema.userBehavior.eventType, "product_view")
      )
    );
  ...
  `;
  const topCategories = topCats.map((r: any) => ({
    category: r.category,
    views: r.views,
  }));
  ...
  `;
  const topProducts = topProds.map((r: any) => ({
    slug: r.slug,
    views: r.views,
  }));
...
// ========================================================================================
export async function getAiUserMemory(
  userId: number
): Promise<schema.AiUserMemory | null> {
  if (!USE_PERSISTENT_DB) return null;
  const rows = await getDb()
    .select()
    .from(schema.aiUserMemory)
    .where(eq(schema.aiUserMemory.userId, userId))
    .limit(1);
  return rows[0] ?? null;
}

export async function upsertAiUserMemory(
  userId: number,
  data: Partial<Omit<schema.InsertAiUserMemory, "userId">>
): Promise<void> {
  if (!USE_PERSISTENT_DB) return;
  const db = getDb();
  const existing = await db
    .select({ id: schema.aiUserMemory.id })
    .from(schema.aiUserMemory)
    .where(eq(schema.aiUserMemory.userId, userId))
    .limit(1);
  if (existing.length > 0) {
    await db
      .update(schema.aiUserMemory)
...
export async function refreshAiUserMemory(userId: number): Promise<void> {
  ...
  const preferredCategories = behaviorSummary.topCategories
    .slice(0, 5)
    .map(c => c.category);
  ...
  if (viewedSlugs.length > 0) {
    const viewedProducts = await db
      ...
      .from(schema.products)
      .where(inArray(schema.products.slug, viewedSlugs));
  ...
  if (lastProductSlugs.length > 0) {
    const prodNames = await db
      .select({
        slug: schema.products.slug,
        name: schema.products.name,
      })
      .from(schema.products)
      .where(inArray(schema.products.slug, lastProductSlugs));
  ...
  const aiSummary = [
    ...
    preferredCategories.length > 0
      ...
      : "",
    preferredStrains.length > 0
      ? `Preferred strains: ${preferredStrains.join(", ")}.`
      : "",
    priceRange
      ? `Price range: $${priceRange.min.toFixed(2)} - $${priceRange.max.toFixed(2)}.`
      : "",
    reviews.length > 0
      ? `Has written ${reviews.length} review(s) with avg rating ${avgRating}.`
      : "",
  ...
  const shoppingPatterns = [
    ...
    behaviorSummary.topProducts.length > 0
      ? `Most viewed products: ${behaviorSummary.topProducts
          .slice(0, 5)
          .map(p => `${p.slug} (${p.views}x)`)
          .join(", ")}.`
      : "",
  ...
  console.log(
    `[AiMemory] Refreshed user #${userId}: ${totalOrders} orders, $${totalSpent.toFixed(2)} spent, ${behaviorSummary.totalPageViews} page views`
  );
}
 ...
 */
export async function refreshAllAiUserMemories(): Promise<{
  refreshed: number;
}> {
...
export async function backfillOrderUserIds(): Promise<number> {
  ...
  for (const uid of Array.from(refreshSet)) {
    try {
      ...
      console.error(
        `[AiMemory] Backfill refresh failed for user #${uid}:`,
        err
      );
    }
  }
  console.log(
    `[OrderBackfill] Linked ${linked} orders to ${refreshSet.size} user(s)`
  );
  return linked;
}
...
export async function getAggregateBehaviorAnalytics(): Promise<{
  ...
  // Total events
  const [totalRow] =
    await _sql!`SELECT count(*)::int as cnt FROM user_behavior`;
  ...
  return {
    topCategories: topCats.map((r: any) => ({
      category: r.category,
      views: r.views,
    })),
    ...
    totalEvents,
    avgEventsPerUser:
      activeUsers > 0 ? Math.round(totalEvents / activeUsers) : 0,
    ...
    proxyRate:
      geoSessionsTotal > 0
        ? parseFloat(((proxySessions / geoSessionsTotal) * 100).toFixed(1))
        : 0,
  };
}
 ...
 */
export async function getAllAiUserMemories(): Promise<
  Array<
    schema.AiUserMemory & {
      userName?: string;
      userEmail?: string;
...
> {
  ...
  const orderMap = new Map<
    number,
    { total: number; spent: number; completed: number }
  >();
  for (const r of orderRows) {
    orderMap.set(r.user_id, {
  ...
  return memories.map(m => {
    ...
    return {
      ...
      liveAvgOrder:
        liveCompleted > 0 ? (liveSpent / liveCompleted).toFixed(2) : "0.00",
    };
  });
}
...
export async function getGeoByProvince(days = 30): Promise<
  Array<{
    province: string;
    provinceCode: string;
    events: number;
...
export async function getGeoByCityRaw(
  days = 30,
  province?: string
): Promise<
  Array<{
...
> {
  if (!USE_PERSISTENT_DB) return [];
  const provFilter = province
    ? _sql!`AND ub.province_code = ${province}`
    : _sql!``;
  const rows = await _sql!`
    SELECT
...
export async function getProductsByRegion(days = 30): Promise<
  Array<{
    province: string;
    provinceCode: string;
    category: string;
...
export async function getProxyStats(
  days = 30
): Promise<{ total: number; proxy: number; rate: number }> {
  ...
  return {
    total,
    proxy,
    rate: total > 0 ? parseFloat(((proxy / total) * 100).toFixed(1)) : 0,
  };
}

/** Daily events, unique visitors, orders for charting */
export async function getGeoDailyTrend(days = 30): Promise<
  Array<{
    date: string;
    events: number;
    visitors: number;
...
export async function getNearestStore(
  ...
  let stores = await db
    ...
    .where(
      and(
        eq(schema.storeLocations.isActive, true),
        ilike(schema.storeLocations.city, city)
      )
    )
    .limit(1);
  ...
  stores = await db
    ...
    .where(
      and(
        eq(schema.storeLocations.isActive, true),
        eq(schema.storeLocations.province, province)
      )
    )
    .orderBy(schema.storeLocations.sortOrder)
    .limit(1);
...
export async function getSiteKnowledge(key: string): Promise<string | null> {
  ...
  const rows = await getDb()
    .select()
    .from(schema.siteKnowledgeSync)
    .where(eq(schema.siteKnowledgeSync.key, key))
    .limit(1);
  return rows[0]?.content ?? null;
}

export async function upsertSiteKnowledge(
  key: string,
  content: string,
  hash?: string
): Promise<void> {
  ...
  const db = getDb();
  const existing = await db
    .select({ id: schema.siteKnowledgeSync.id })
    .from(schema.siteKnowledgeSync)
    .where(eq(schema.siteKnowledgeSync.key, key))
    .limit(1);
  if (existing.length > 0) {
    await db
      .update(schema.siteKnowledgeSync)
      .set({ content, contentHash: hash, lastSyncedAt: new Date() })
      .where(eq(schema.siteKnowledgeSync.key, key));
  } else {
    await db
      .insert(schema.siteKnowledgeSync)
      .values({ key, content, contentHash: hash });
  }
}

export async function getAllSiteKnowledge(): Promise<
  schema.SiteKnowledgeSync[]
> {
  if (!USE_PERSISTENT_DB) return [];
...
export async function syncAllSiteKnowledge(): Promise<void> {
      ...
      items: [
        {
          ...
          a: "We accept Interac e-Transfer as our payment method. Send your e-Transfer to our payment email with your order number in the message.",
        },
        {
  ...
  const termsContent = [
    {
      ...
      content:
        "You must be at least 19 years of age to use this website and purchase products from My Legacy Cannabis.",
    },
    {
      title: "Products",
      content:
        "All products sold by My Legacy Cannabis are intended for legal use in Canada. Product availability, pricing, and descriptions are subject to change without notice.",
    },
    {
      title: "Ordering & Payment",
      content:
        "The minimum order amount is $40. We currently accept Interac e-Transfer. Orders are processed once payment is received. No taxes are charged on orders.",
    },
    {
    ...
    },
    {
      ...
      content:
        "We cannot accept returns on opened products. If you receive a damaged or incorrect item, contact us within 48 hours with photos.",
    },
    {
      title: "Rewards Program",
      content:
        "Points earned on completed orders. Points never expire for active accounts. Rewards cannot exceed 50% of order subtotal.",
    },
    {
    ...
    },
    {
      title: "Contact",
      content:
        "For questions about Terms & Conditions, contact support@mylegacycannabis.ca or call (437) 215-4722.",
    },
  ];
  ...
  const privacyContent = [
    {
      ...
      content:
        "Name, email, phone, shipping address, government ID for age verification, payment info, communication preferences, birthday.",
    },
    {
      title: "How We Use Your Information",
      content:
        "To process orders, verify age/identity, manage rewards account, communicate about orders and promotions, improve services, comply with legal obligations.",
    },
    {
      title: "ID Verification Data",
      content:
        "Government ID documents are securely transmitted using encryption, used solely for age verification, deleted after verification, and never shared with third parties.",
    },
    {
      title: "Data Security",
      content:
    ...
    },
    {
      ...
      content:
        "We use cookies to enhance browsing, remember preferences, and analyze traffic.",
    },
    {
      title: "Your Rights",
      content:
        "Access, correct, delete your data. Opt out of marketing. Request a data copy.",
    },
    {
      title: "Contact",
      content: "privacy@mylegacycannabis.ca or (437) 215-4722.",
    },
  ];
  ...
  console.log(
    `[KnowledgeSync] Synced: ${products.length} products, ${Object.keys(catCounts).length} categories, ${zones.length} zones, ${locations.length} locations, FAQ, terms, privacy, shipping policy, ${templates.length} email templates`
  );
}
...
async function seedPersistentData(db: PostgresJsDatabase<typeof schema>) {
  ...
  for (const o of seedOrders) {
    ...
    if (o.items.length > 0) {
      await db
        ...
        .values(o.items.map(i => ({ ...i, orderId: order.id })));
    }
  }
  ...
  console.log(
    `[DB] Seeded: admin user, ${seedProducts.length} products, ${seedShippingZones.length} zones, ${seedEmailTemplates.length} templates, ${seedOrders.length} orders, ${seedVerifications.length} verifications`
  );
}
...
function getSeedData() {
  const img =
    "https://images.unsplash.com/photo-1603909223429-69bb7101f420?w=500&q=80";
  const imgs = [
  ...
  const seedProducts: schema.InsertProduct[] = [
    // ── INDICA FLOWER ──
    {
      ...
      thc: "29-33%",
      description:
        "Pink Taco is a top-shelf AAAA indica with an intense aroma and heavy-hitting effects. Deep relaxation and blissful euphoria.",
      shortDescription: "AAAA indica — 29-33% THC. Deep relaxation.",
      image: img,
      images: imgs,
      stock: 30,
      featured: true,
    ...
    },
    {
      ...
      thc: "27-29%",
      description:
        "Prada Pink delivers smooth, luxurious indica effects with a sweet floral aroma. Premium AAA+ quality.",
      shortDescription: "AAA+ indica — sweet floral aroma.",
      image: img,
      images: imgs,
      stock: 40,
      featured: true,
    ...
    },
    {
      ...
      thc: "27-29%",
      description:
        "Hydro Pink is a hydroponically grown indica with dense, trichome-coated buds. Powerful body high.",
      shortDescription: "AAA+ hydroponic indica — dense buds, powerful.",
      image: img,
      images: imgs,
      stock: 35,
      featured: false,
    ...
    {
      name: "Platinum Rockstar",
      slug: "platinum-rockstar",
      category: "flower",
      strainType: "Indica",
      subcategory: "Indica Flower",
      grade: "AAA",
      ...
      thc: "25-27%",
      description:
        "Platinum Rockstar is a classic AAA indica known for its sedating effects and earthy kush flavour.",
      shortDescription: "AAA indica — earthy kush, deeply sedating.",
      image: img,
      images: imgs,
      stock: 45,
      featured: false,
    ...
    {
      name: "Pink Gas Chamber",
      slug: "pink-gas-chamber",
      category: "flower",
      strainType: "Indica",
      subcategory: "Indica Flower",
      grade: "AAA",
      ...
      thc: "25-27%",
      description:
        "Pink Gas Chamber packs a gassy punch with dense pink-hued buds. AAA quality at a great price.",
      shortDescription: "AAA indica — gassy aroma, pink buds.",
      image: img,
      images: imgs,
      stock: 40,
      featured: false,
    ...
    },
    {
      ...
      thc: "25-27%",
      description:
        "Gucci Pink is a smooth, flavourful indica with premium bag appeal. Relaxing full-body effects.",
      shortDescription: "AAA indica — smooth and flavourful.",
      image: img,
      images: imgs,
      stock: 40,
      featured: false,
    ...
    },
    {
      ...
      thc: "22-24%",
      description:
        "Afghani OG is a landrace-influenced indica with heavy, sleepy effects and a classic hash-like aroma.",
      shortDescription: "AAA- indica — classic Afghani hash aroma.",
      image: img,
      images: imgs,
      stock: 50,
      featured: false,
    ...
    },
    {
      ...
      thc: "22-24%",
      description:
        "Gushers is a fruity indica with a candy-like taste and relaxing, euphoric effects.",
      shortDescription: "AAA- indica — fruity candy flavour.",
      image: img,
      images: imgs,
      stock: 50,
      featured: false,
    ...
    },
    {
      ...
      thc: "20-22%",
      description:
        "Purple Snow is a budget-friendly indica with beautiful purple hues and a mellow, relaxing high.",
      shortDescription: "AA+ indica — purple hues, mellow high.",
      image: img,
      images: imgs,
      stock: 60,
      featured: false,
    ...
    {
      name: "Musang Pink Small",
      slug: "musang-pink-small",
      category: "flower",
      strainType: "Indica",
      subcategory: "Indica Flower",
      grade: "AA+",
      ...
      thc: "20-22%",
      description:
        "Musang Pink Small buds deliver the same great Pink Kush genetics at an unbeatable price.",
      shortDescription: "AA+ indica smalls — great value.",
      image: img,
      images: imgs,
      stock: 70,
      featured: false,
    ...
    },
    {
      ...
      thc: "20-22%",
      description:
        "White Truffle is a unique indica with a pungent, earthy truffle aroma and calming effects.",
      shortDescription: "AA+ indica — pungent truffle aroma.",
      image: img,
      images: imgs,
      stock: 55,
      featured: false,
    ...
    // ── SATIVA FLOWER ──
    {
      ...
      thc: "29-33%",
      description:
        "Lemon Pledge is a top-tier AAAA sativa with a bright citrus aroma and energizing, uplifting effects.",
      shortDescription: "AAAA sativa — bright citrus, energizing.",
      image: img,
      images: imgs,
      stock: 25,
      featured: true,
    ...
    },
    {
      ...
      thc: "25-27%",
      description:
        "Vanilla Lime is a smooth sativa with a creamy vanilla and zesty lime flavour profile.",
      shortDescription: "AAA sativa — vanilla and lime flavour.",
      image: img,
      images: imgs,
      stock: 40,
      featured: false,
    ...
    },
    {
      ...
      thc: "25-27%",
      description:
        "Pineapple Skies is a tropical sativa with sweet pineapple notes and a creative, euphoric high.",
      shortDescription: "AAA sativa — tropical pineapple flavour.",
      image: img,
      images: imgs,
      stock: 35,
      featured: false,
    ...
    },
    {
      ...
      thc: "23-24%",
      description:
        "Super Lemon Haze is a two-time Cannabis Cup winner with zesty lemon flavour and energetic effects.",
      shortDescription: "AAA- sativa — award-winning lemon strain.",
      image: img,
      images: imgs,
      stock: 45,
      featured: false,
    ...
    },
    {
      ...
      thc: "23-24%",
      description:
        "Hawaiian Snow is a tropical sativa with a spicy, citrus aroma and long-lasting cerebral high.",
      shortDescription: "AAA- sativa — tropical and cerebral.",
      image: img,
      images: imgs,
      stock: 45,
      featured: false,
    ...
    },
    {
      ...
      thc: "20-22%",
      description:
        "Jamaican Lime is a budget-friendly sativa with bright lime flavour and uplifting daytime effects.",
      shortDescription: "AA+ sativa — lime flavour, uplifting.",
      image: img,
      images: imgs,
      stock: 60,
      featured: false,
    ...
    // ── HYBRID FLOWER ──
    {
      ...
      thc: "28-30%",
      description:
        "Zoda is a high-potency hybrid with a fizzy, sweet flavour profile and balanced head/body effects.",
      shortDescription: "AAA+ hybrid — fizzy sweet, 28-30% THC.",
      image: img,
      images: imgs,
      stock: 35,
      featured: true,
    ...
    },
    {
      ...
      thc: "25-27%",
      description:
        "Cream Soda is a creamy, sweet hybrid with balanced relaxation and euphoria.",
      shortDescription: "AAA hybrid — creamy and sweet.",
      image: img,
      images: imgs,
      stock: 40,
      featured: false,
    ...
    },
    {
      ...
      thc: "25-27%",
      description:
        "Red Velvet is a rich, dessert-flavoured hybrid with smooth effects and beautiful bag appeal.",
      shortDescription: "AAA hybrid — dessert flavour, smooth effects.",
      image: img,
      images: imgs,
      stock: 40,
      featured: false,
    ...
    {
      name: "Purple Sour Patch Kids",
      slug: "purple-sour-patch-kids",
      category: "flower",
      strainType: "Hybrid",
      subcategory: "Hybrid Flower",
      grade: "AAA",
      ...
      thc: "23-25%",
      description:
        "Purple Sour Patch Kids delivers sour candy flavour with a relaxing, giggly hybrid high.",
      shortDescription: "AAA hybrid — sour candy flavour.",
      image: img,
      images: imgs,
      stock: 45,
      featured: false,
    ...
    },
    {
      ...
      thc: "23-25%",
      description:
        "Cake Bomb is a doughy, sweet hybrid with heavy-hitting effects. Sold in 7g increments.",
      shortDescription: "AAA hybrid — doughy cake flavour.",
      image: img,
      images: imgs,
      stock: 40,
      featured: false,
    ...
    },
    {
      ...
      thc: "20-22%",
      description:
        "Wedding Cake is a tangy, peppery hybrid known for relaxing euphoria and rich flavour.",
      shortDescription: "AAA- hybrid — tangy, relaxing euphoria.",
      image: img,
      images: imgs,
      stock: 50,
      featured: false,
    ...
    },
    {
      ...
      thc: "20-22%",
      description:
        "Cream Mintz is a minty, creamy hybrid with calming effects. Great value at AAA- grade.",
      shortDescription: "AAA- hybrid — minty cream flavour.",
      image: img,
      images: imgs,
      stock: 55,
      featured: false,
    ...
    },
    {
      ...
      thc: "20-22%",
      description:
        "Banana Sundae is a sweet, fruity hybrid with a banana cream flavour. Sold in 14g bags.",
      shortDescription: "AAA- hybrid — banana cream flavour, 14g.",
      image: img,
      images: imgs,
      stock: 35,
      featured: false,
    ...
    // ── OUNCE DEALS ──
    {
      name: "Sour OG",
      slug: "sour-og",
      category: "ounce-deals",
      strainType: "Hybrid",
      subcategory: "Ounce Deals",
      grade: "AA",
      price: "40.00",
      weight: "28g",
      thc: "18-19%",
      description:
        "Sour OG is a classic hybrid at an unbeatable ounce deal price. Sour diesel meets OG Kush.",
      shortDescription: "AA ounce deal — sour diesel x OG Kush.",
      image: img,
      images: imgs,
      stock: 30,
      featured: true,
    ...
    },
    {
      ...
      thc: "18-19%",
      description:
        "Granola Funk is a nutty, earthy hybrid perfect for budget-conscious buyers. Full ounce deal.",
      shortDescription: "AA ounce deal — nutty and earthy.",
      image: img,
      images: imgs,
      stock: 30,
      featured: false,
    ...
    // ── SHAKE N BAKE ──
    {
      name: "Shake and Bake Premium",
      slug: "shake-bake-premium",
      category: "shake-n-bake",
      strainType: "Hybrid",
      subcategory: "Shake n Bake",
      grade: "SHAKE",
      price: "40.00",
      weight: "28g",
      thc: "24-26%",
      description:
        "Premium shake and bake mix — perfect for edibles, joints, or bong bowls. High THC content.",
      shortDescription: "Premium shake — 24-26% THC, 28g.",
      image: img,
      images: imgs,
      stock: 40,
      featured: false,
    ...
    {
      name: "Shake and Bake Regular",
      slug: "shake-bake-regular",
      category: "shake-n-bake",
      strainType: "Hybrid",
      subcategory: "Shake n Bake",
      grade: "SHAKE",
      ...
      thc: "20-23%",
      description:
        "Regular shake and bake mix at an everyday low price. Great for cooking or rolling.",
      shortDescription: "Regular shake — 20-23% THC, 28g.",
      image: img,
      images: imgs,
      stock: 50,
      featured: false,
    ...
    // ── PRE-ROLLS ──
    {
      ...
      weight: "3x0.5g",
      thc: "20-24%",
      description: "Three perfectly rolled 0.5g indica joints.",
    ...
    },
    {
      ...
      weight: "3x0.5g",
      thc: "22-26%",
      description: "Three energizing sativa pre-rolls.",
    ...
    },
    {
      ...
      thc: "35-40%",
      description:
        "A premium 1g king-size pre-roll infused with live resin concentrate and rolled in kief.",
      shortDescription: "King-size infused joint — live resin + kief.",
      image:
        "https://images.unsplash.com/photo-1579154204601-01588f351e67?w=500&q=80",
      images: [
        "https://images.unsplash.com/photo-1579154204601-01588f351e67?w=800&q=80",
    ...
    // ── EDIBLES ──
    {
      ...
      weight: "10 pieces",
      thc: "10mg/pack",
      description: "Delicious mixed fruit gummies infused with 10mg THC total.",
      shortDescription: "Mixed fruit gummies — 10mg THC total.",
      image:
        "https://images.unsplash.com/photo-1611070022631-46e9ec1bc3e5?w=500&q=80",
      images: [
        "https://images.unsplash.com/photo-1611070022631-46e9ec1bc3e5?w=800&q=80",
      ],
      stock: 100,
      featured: true,
      isNew: false,
    ...
    },
    {
      ...
      weight: "1 bar",
      thc: "10mg/bar",
      description: "Rich dark chocolate bar infused with 10mg THC.",
      shortDescription: "Dark chocolate bar — 10mg THC.",
      image:
        "https://images.unsplash.com/photo-1611070022631-46e9ec1bc3e5?w=500&q=80",
      images: [
        "https://images.unsplash.com/photo-1611070022631-46e9ec1bc3e5?w=800&q=80",
    ...
    // ── VAPES ──
    {
      ...
      weight: "1g",
      thc: "85-90%",
      description: "Premium 1g vape cartridge filled with OG Kush distillate.",
      shortDescription: "OG Kush distillate cart — 1g, 85-90% THC.",
      image:
        "https://images.unsplash.com/photo-1563298723-dcfebaa392e3?w=500&q=80",
      images: [
    ...
    },
    {
      ...
      weight: "0.5g",
      thc: "80-85%",
      description: "Disposable vape pen with strawberry indica distillate.",
      shortDescription: "Disposable strawberry indica pen — 0.5g.",
      image:
        "https://images.unsplash.com/photo-1563298723-dcfebaa392e3?w=500&q=80",
      images: [
        "https://images.unsplash.com/photo-1563298723-dcfebaa392e3?w=800&q=80",
    ...
    // ── CONCENTRATES ──
    {
      ...
      weight: "1g",
      thc: "70-80%",
      description: "Premium live resin from fresh-frozen Gelato flower.",
      shortDescription: "Gelato live resin — full-spectrum.",
      image:
    ...
    },
    {
      ...
      weight: "1g",
      thc: "90-99%",
      description: "Ultra-pure THCA crystalline diamonds.",
      shortDescription: "THCA diamonds — 90-99% pure.",
      image:
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=500&q=80",
      images: [
        "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=80",
    ...
    // ── ACCESSORIES ──
    {
      ...
      weight: "1 unit",
      thc: "N/A",
      description: "Heavy-duty 4-piece aluminum grinder with kief catcher.",
      shortDescription: "4-piece aluminum grinder with kief catcher.",
      image:
        "https://images.unsplash.com/photo-1585063560381-04b76b4d5a8f?w=500&q=80",
      images: [
        "https://images.unsplash.com/photo-1585063560381-04b76b4d5a8f?w=800&q=80",
      ],
      stock: 80,
      featured: false,
      isNew: false,
    ...
    },
    {
      ...
      weight: "1 unit",
      thc: "N/A",
      description: "Hand-blown borosilicate glass water pipe with ice catcher.",
      shortDescription: '12" glass water pipe with ice catcher.',
      image:
        "https://images.unsplash.com/photo-1585063560381-04b76b4d5a8f?w=500&q=80",
      images: [
        "https://images.unsplash.com/photo-1585063560381-04b76b4d5a8f?w=800&q=80",
  ...
  const seedShippingZones: schema.InsertShippingZone[] = [
    ...
    {
      zoneName: "Rest of Canada",
      provinces: ["MB", "SK", "NS", "NB", "NL", "PE", "NT", "YT", "NU"],
      rate: "16.99",
      freeThreshold: "175.00",
      estimatedDays: "7-10",
      deliveryDays: "7-10",
      isActive: true,
    },
  ...
  const seedOrders: Array<{
    order: schema.InsertOrder;
    items: Omit<schema.InsertOrderItem, "orderId">[];
  }> = [
    {
      order: {
        ...
        trackingNumber: "TRKEXAMPLE001",
      },
      items: [
        { productName: "Blue Dream", price: "38.00", quantity: 1 },
        { productName: "Indica Pre-Roll Pack", price: "25.00", quantity: 1 },
        { productName: "Premium Grinder", price: "25.00", quantity: 1 },
      ],
    },
    {
      order: {
        ...
        trackingNumber: "TRKEXAMPLE002",
      },
      items: [
        { productName: "OG Kush Vape Cart", price: "45.00", quantity: 2 },
        { productName: "Mixed Fruit Gummies", price: "15.00", quantity: 1 },
        { productName: "Dark Chocolate Bar", price: "12.00", quantity: 1 },
      ],
    },
    {
      order: {
      ...
      items: [
        { productName: "Purple Kush", price: "35.00", quantity: 1 },
        { productName: "Sativa Pre-Roll Pack", price: "25.00", quantity: 1 },
      ],
    },
    {
      order: {
      ...
      items: [
        { productName: "THCA Diamonds", price: "65.00", quantity: 2 },
        { productName: "Live Resin — Gelato", price: "50.00", quantity: 1 },
        { productName: "Glass Water Pipe", price: "75.00", quantity: 1 },
      ],
    },
    {
      order: {
        ...
        trackingNumber: "TRKEXAMPLE005",
      },
      items: [
        { productName: "Gelato", price: "44.00", quantity: 1 },
        {
          productName: "Blue Raspberry Live Resin Cart",
          price: "55.00",
          quantity: 1,
        },
      ],
  ...
  const seedVerifications: schema.InsertIdVerification[] = [
    {
      ...
      reviewNotes: "Valid Ontario DL confirmed",
    },
    {
      guestEmail: "sarah@example.com",
      guestName: "Sarah Johnson",
      ...
      status: "approved",
      reviewedBy: 1,
      reviewedAt: new Date(Date.now() - 8 * 86400000),
      reviewNotes: "Valid Canadian passport",
    },
    {
      guestEmail: "mike@example.com",
      guestName: "Mike Williams",
...
export async function updatePushSubscriptionLastPushed(
  id: number
): Promise<void> {
  if (!USE_PERSISTENT_DB) return;
  await getDb()
...
export async function logPushNotification(
  data: schema.InsertPushNotificationLog
): Promise<void> {
  if (!USE_PERSISTENT_DB) return;
...
export async function getPushNotificationLogs(opts?: {
  ...
  let q = db
    .select()
    .from(schema.pushNotificationLog)
...
// ─── IP / GEO TRACKING ───
export async function updateUserIpGeo(
  userId: number,
  ip: string,
  geo?: {
    city?: string;
...
function seedInMemoryData() {
  ...
  for (const v of seedVerifications) {
    _idVerifications.push({
      ...
      createdAt: new Date(now.getTime() - Math.random() * 15 * 86400000),
      updatedAt: new Date(),
    });
  }

  console.log(
    `[DB] In-memory: ${_products.length} products, ${_shippingZones.length} zones, ${_orders.length} orders, ${_idVerifications.length} verifications`
  );
}
...
function _mem_upsertUser(user: any) {
  ...
  if (existing) {
    for (const k of Object.keys(user)) {
      if (user[k] !== undefined) (existing as any)[k] = user[k];
    }
...
function _mem_getUserByOpenId(openId: string) {
  return _users.find(u => u.openId === openId);
}
function _mem_getUserByEmail(email: string) {
  return _users.find(u => u.email?.toLowerCase() === email.toLowerCase());
}
function _mem_getUserByPhone(phone: string) {
  return _users.find(u => u.phone === phone);
}
function _mem_getUserByGoogleId(googleId: string) {
  return _users.find(u => u.googleId === googleId);
}
function _mem_getUserById(id: number) {
...
function _mem_updateUser(id: number, data: any) {
  const u = _users.find(u => u.id === id);
  if (u) Object.assign(u, data, { updatedAt: new Date() });
}
function _mem_deleteUser(id: number) {
...
function _mem_getUserOrders(userId: number) {
  ...
  return _orders
    .filter(
      (o: any) =>
        (user.email &&
          o.guestEmail?.toLowerCase() === user.email.toLowerCase()) ||
        (user.phone && o.guestPhone === user.phone)
    )
    .sort((a: any, b: any) => b.createdAt.getTime() - a.createdAt.getTime());
}
function _mem_createVerificationCode(data: any) {
  const id = nextId();
  _verificationCodes.push({
    id,
    ...data,
    attempts: 0,
    verified: false,
...
function _mem_verifyCode(identifier: string, code: string, type: string) {
  ...
  if (r.code !== code) {
    ...
    return {
      valid: false,
      reason: `Incorrect code. ${4 - r.attempts} attempts remaining.`,
    };
  }
  r.verified = true;
  return { valid: true };
...
function _mem_getAllProducts(opts?: any) {
  ...
  return {
    data: paginate(sorted, opts?.page ?? 1, opts?.limit ?? 50),
    total: sorted.length,
  };
}
function _mem_getProductById(id: number) {
  return _products.find(p => p.id === id);
}
function _mem_getProductBySlug(slug: string) {
...
function _mem_createProduct(data: any) {
  const id = nextId();
  const now = new Date();
  _products.push({
    id,
...
function _mem_getAllOrders(opts?: any) {
  ...
  if (opts?.dateFrom)
    filtered = filtered.filter(o => o.createdAt >= opts.dateFrom);
...
function _mem_getOrderById(id: number) {
  return _orders.find(o => o.id === id);
}
function _mem_getOrderItems(orderId: number) {
  return _orderItems.filter(i => i.orderId === orderId);
}
function _mem_createOrder(data: any) {
  const id = nextId();
  _orders.push({ id, ...data, createdAt: new Date(), updatedAt: new Date() });
  return id;
}
function _mem_createOrderItems(items: any[]) {
  for (const item of items)
    _orderItems.push({ id: nextId(), ...item, createdAt: new Date() });
}
function _mem_updateOrder(id: number, data: any) {
  const o = _orders.find(o => o.id === id);
  if (o) Object.assign(o, data, { updatedAt: new Date() });
}
function _mem_getAllVerifications(opts?: any) {
  const allNorm = _idVerifications.map((v: any) => ({
    ...v,
  ...
  if (opts?.email)
    filtered = filtered.filter(
      (v: any) =>
        (v.guestEmail || "").toLowerCase() === opts.email.toLowerCase()
    );
  const sorted = filtered.sort(
    (a: any, b: any) => b.createdAt.getTime() - a.createdAt.getTime()
  );
...
function _mem_getVerificationById(id: number) {
  const v = _idVerifications.find((v: any) => v.id === id);
  return v ? { ...v, status: v.status || "pending" } : undefined;
}
function _mem_createVerification(data: any) {
  const id = nextId();
  _idVerifications.push({
    id,
    status: "pending",
...
function _mem_updateVerification(id: number, data: any) {
  const v = _idVerifications.find((v: any) => v.id === id);
  if (v) Object.assign(v, data, { updatedAt: new Date() });
}
function _mem_getAllShippingZones() {
  return [..._shippingZones].sort((a: any, b: any) => a.id - b.id);
}
function _mem_updateShippingZone(id: number, data: any) {
  const z = _shippingZones.find((z: any) => z.id === id);
  if (z) Object.assign(z, data, { updatedAt: new Date() });
}
function _mem_createShippingZone(data: any) {
  const id = nextId();
  _shippingZones.push({
    id,
    ...data,
...
function _mem_getAllEmailTemplates() {
  return [..._emailTemplates].sort((a: any, b: any) =>
    a.slug.localeCompare(b.slug)
  );
}
function _mem_getEmailTemplateBySlug(slug: string) {
  return _emailTemplates.find((t: any) => t.slug === slug);
}
function _mem_updateEmailTemplate(id: number, data: any) {
  const t = _emailTemplates.find((t: any) => t.id === id);
  if (t) Object.assign(t, data, { updatedAt: new Date() });
}
function _mem_createEmailTemplate(data: any) {
  const id = nextId();
  _emailTemplates.push({
    id,
    ...data,
...
function _mem_logAdminActivity(data: any) {
  _adminActivityLog.push({ id: nextId(), ...data, createdAt: new Date() });
}
function _mem_getAdminActivityLog(opts?: any) {
  const sorted = [..._adminActivityLog].sort(
    (a: any, b: any) => b.createdAt.getTime() - a.createdAt.getTime()
  );
  return {
    data: paginate(sorted, opts?.page ?? 1, opts?.limit ?? 50),
...
function _mem_addRewardsHistory(data: any) {
  _rewardsHistory.push({ id: nextId(), ...data, createdAt: new Date() });
}
function _mem_getRewardsHistoryByUser(userId: number) {
...
function _mem_getDashboardStats() {
  return {
    ...
    totalRevenue: _orders
      .filter(
        o => o.paymentStatus === "confirmed" || o.paymentStatus === "received"
      )
      .reduce((sum, o) => sum + parseFloat(o.total ?? "0"), 0),
    pendingVerifications: _idVerifications.filter(
      (v: any) => !v.status || v.status === "pending"
    ).length,
    totalProducts: _products.filter(p => p.isActive).length,
    totalUsers: _users.length,
    recentOrders: [..._orders].sort(
      (a, b) => b.createdAt.getTime() - a.createdAt.getTime()
    ),
  };
}
function _mem_getOrderStats(days = 30) {
  ...
  for (const o of filtered) {
    ...
    const ex = byDate.get(date) ?? { orderCount: 0, revenue: 0 };
    ex.orderCount++;
    ex.revenue += parseFloat(o.total ?? "0");
    byDate.set(date, ex);
  }
...
function _mem_getTopProducts(limit = 10) {
  ...
  for (const i of _orderItems) {
    const ex = byProd.get(i.productName) ?? { totalSold: 0, totalRevenue: 0 };
    ex.totalSold += i.quantity;
    ex.totalRevenue += parseFloat(i.price ?? "0") * i.quantity;
    byProd.set(i.productName, ex);
  }
  return Array.from(byProd.entries())
    .map(([productName, s]) => ({
      productName,
...
function _mem_getAllCoupons() {
  return [..._coupons].sort(
    (a: any, b: any) => b.createdAt.getTime() - a.createdAt.getTime()
  );
}
function _mem_getCouponByCode(code: string) {
  return _coupons.find((c: any) => c.code.toUpperCase() === code.toUpperCase());
}
function _mem_getCouponById(id: number) {
  return _coupons.find((c: any) => c.id === id);
}
function _mem_createCoupon(data: any) {
  const id = nextId();
  _coupons.push({
    id,
    ...data,
...
function _mem_updateCoupon(id: number, data: any) {
  const c = _coupons.find((c: any) => c.id === id);
  if (c) Object.assign(c, data, { updatedAt: new Date() });
}
function _mem_deleteCoupon(id: number) {
  const idx = _coupons.findIndex((c: any) => c.id === id);
  if (idx !== -1) _coupons.splice(idx, 1);
}
function _mem_getCouponUsageByEmail(couponId: number, email: string) {
  return _couponUsage.filter(
    (u: any) =>
      u.couponId === couponId && u.email.toLowerCase() === email.toLowerCase()
  ).length;
}
function _mem_recordCouponUsage(data: any) {
  _couponUsage.push({ id: nextId(), ...data, createdAt: new Date() });
  const c = _coupons.find((c: any) => c.id === data.couponId);
  if (c) c.usageCount = (c.usageCount || 0) + 1;
}

// ─── IN-MEMORY REFERRAL STUBS ───
function _mem_getReferralCodeByUserId(userId: number) {
  return _referralCodes.find((r: any) => r.userId === userId);
}
function _mem_getReferralCodeByCode(code: string) {
  return _referralCodes.find(
    (r: any) => r.code.toUpperCase() === code.toUpperCase()
  );
}
function _mem_createReferralCode(data: any) {
  const id = nextId();
  _referralCodes.push({ id, ...data, timesUsed: 0, createdAt: new Date() });
  return id;
}
function _mem_trackReferral(data: any) {
  const id = nextId();
  _referralTracking.push({ id, ...data, createdAt: new Date() });
  return id;
}
function _mem_getReferralTracking(referrerId: number) {
  return [..._referralTracking]
    .filter((r: any) => r.referrerId === referrerId)
    .sort((a: any, b: any) => b.createdAt.getTime() - a.createdAt.getTime());
}

// ─── IN-MEMORY REVIEW STUBS ───
function _mem_createProductReview(data: any) {
  const id = nextId();
  _productReviews.push({
    id,
    ...data,
    isApproved: true,
    pointsAwarded: false,
...
function _mem_getProductReviews(productId: number) {
...
function _mem_getAllReviews(opts?: any) {
  const sorted = [..._productReviews].sort(
    (a: any, b: any) => b.createdAt.getTime() - a.createdAt.getTime()
  );
  return {
    data: paginate(sorted, opts?.page ?? 1, opts?.limit ?? 50),
...
function _mem_approveReview(id: number) {
  const r = _productReviews.find((r: any) => r.id === id);
  if (r) {
    r.isApproved = true;
    r.updatedAt = new Date();
  }
}
function _mem_updateReviewPointsAwarded(id: number) {
  const r = _productReviews.find((r: any) => r.id === id);
  if (r) {
...
function _mem_updateProductReview(id: number, data: any) {
  const r = _productReviews.find((r: any) => r.id === id);
  if (r) Object.assign(r, data, { updatedAt: new Date() });
}
function _mem_deleteProductReview(id: number) {
  const idx = _productReviews.findIndex((r: any) => r.id === id);
  if (idx !== -1) _productReviews.splice(idx, 1);
}
function _mem_getReviewById(id: number) {
  return _productReviews.find((r: any) => r.id === id);
}

// ─── IN-MEMORY E-TRANSFER PAYMENT STUBS ───
const _mem_paymentRecords: any[] = [];
function _mem_createPaymentRecord(data: any) {
  const id = nextId();
  _mem_paymentRecords.push({ id, ...data, createdAt: new Date() });
  return id;
}
function _mem_getAllPaymentRecords(opts?: any) {
  const sorted = [..._mem_paymentRecords].sort(
    (a: any, b: any) => b.createdAt.getTime() - a.createdAt.getTime()
  );
  const filtered = opts?.status
    ? sorted.filter((p: any) => p.status === opts.status)
    : sorted;
  return {
    data: paginate(filtered, opts?.page ?? 1, opts?.limit ?? 50),
    total: filtered.length,
  };
}
function _mem_updatePaymentRecord(id: number, data: any) {
  const r = _mem_paymentRecords.find((p: any) => p.id === id);
  if (r) Object.assign(r, data);
}
function _mem_getPendingETransferOrders() {
  return [..._orders]
    .filter(
      o =>
