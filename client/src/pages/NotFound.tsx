    ...
    <>
      ...
      <section className="bg-[#4B2D8E] py-16 md:py-24">
        <div className="container text-center">
          <h1 className="font-display text-7xl md:text-9xl text-[#F15929] mb-4">404</h1>
          <h2 className="font-display text-2xl md:text-3xl text-white mb-4">PAGE NOT FOUND</h2>
