          ...
          <div className="prose prose-lg max-w-none font-body text-gray-600 space-y-6">
            <div className="bg-[#F5F5F5] rounded-2xl p-6">
              ...
              <ul className="text-sm space-y-1 mt-2 list-disc pl-5">
                <li>
                  Name, email address, phone number, and shipping address when
                  you create an account or place an order
                </li>
                <li>
                  Government-issued photo ID for age verification purposes (19+
                  requirement)
                </li>
            ...
            <div className="bg-[#F5F5F5] rounded-2xl p-6">
              ...
              <ul className="text-sm space-y-1 list-disc pl-5">
                ...
                <li>
                  To verify your age and identity as required by Canadian law
                </li>
                <li>To manage your My Legacy Rewards account and points</li>
                <li>
                  To communicate with you about orders, products, and promotions
                </li>
            ...
            <div className="bg-[#F5F5F5] rounded-2xl p-6">
              <h2 className="font-display text-xl text-[#4B2D8E] mb-3">
                3. ID VERIFICATION DATA
              </h2>
              <p className="text-sm">
                Government-issued ID documents submitted for age verification
                are:
              </p>
              <ul className="text-sm space-y-1 mt-2 list-disc pl-5">
            ...
            <div className="bg-[#F5F5F5] rounded-2xl p-6">
              ...
              <p className="text-sm mt-2">
                <strong>Email:</strong> privacy@mylegacycannabis.ca
              </p>
              <p className="text-sm">
                <strong>Phone:</strong> (437) 215-4722
              </p>
            </div>
          </div>
        </div>
