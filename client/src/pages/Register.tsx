...
export default function Register() {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      if (data.fallback) {
        toast.info(
          "SMS is being set up. Your code has been logged — contact support for your code during testing."
        );
      } else {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-white/60 font-body text-sm mt-1">
              Join My Legacy Rewards — earn points on every purchase
            </p>
          </div>
          ...
          <div className="bg-[#F15929] rounded-xl p-3 mb-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/80 text-xs font-body">
                Earn 25 reward points just for creating your account
              </p>
            </div>
          </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-3 mb-4 flex items-start gap-2">
                ...
                <p className="text-sm text-red-700 font-body">
                  ...
                  {error.includes("already exists") && (
                    <Link
                      href="/login"
                      className="text-[#4B2D8E] font-semibold underline ml-1"
                    >
                      Sign In
                    </Link>
                  )}
            ...
            {step === "info" && (
              <div className="space-y-4">
                ...
                <div>
                  {!showReferral ? (
                    ...
                    <>
                      <label className="block text-xs font-display text-[#333] mb-1.5">
                        REFERRAL CODE{" "}
                        <span className="text-gray-400 font-body normal-case font-normal">
                          (optional)
                        </span>
                      </label>
                      <div className="relative">
                      ...
                      <p className="text-xs text-gray-400 font-body mt-1">
                        You and your friend both earn bonus points!
                      </p>
                    </>
                  )}
                </div>
                ...
                <div>
                  <label className="block text-xs font-display text-[#333] mb-1.5">
                    DATE OF BIRTH *{" "}
                    <span className="text-[#F15929] font-body normal-case font-normal">
                      (must be 19+)
                    </span>
                  </label>
                  <div className="relative">
                  ...
                  <p className="text-xs text-gray-400 font-body mt-1">
                    You must be 19 years of age or older to purchase cannabis in
                    Ontario
                  </p>
                </div>
                ...
                <div className="relative py-2">
                  ...
                  <div className="relative flex justify-center">
                    <span className="bg-white px-4 text-xs text-gray-400 font-body">
                ...
                <Link
                  href="/login"
                  className="block w-full text-center border-2 border-[#4B2D8E] text-[#4B2D8E] hover:bg-[#4B2D8E] hover:text-white font-display text-sm py-3 rounded-full transition-all"
                >
                  SIGN IN
                </Link>
            ...
            {step === "verify" && (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-sm text-gray-500 hover:text-[#4B2D8E] font-body transition-colors"
                >
                ...
                <div className="bg-[#F5F5F5] rounded-xl p-4 space-y-1">
                  ...
                  {referralCode && (
                    <div className="flex items-center gap-2 text-sm font-body">
                      ...
                      <span className="text-gray-600">
                        Referral:{" "}
                        <span className="font-mono text-[#F15929]">
                          {referralCode}
                        </span>
                      </span>
                    </div>
                ...
                >
                  ...
                  <div className="text-left flex-1">
                    ...
                    <p className="text-xs text-gray-500 font-body">
                      {smsAvailable
                        ? `Text code to +1 ${phone}`
                        : `SMS coming soon — code logged for testing`}
                    </p>
                  </div>
                  {loading && verifyMethod === "sms" ? (
                    <Loader2
                      size={16}
                      className="animate-spin text-[#F15929]"
                    />
                  ) : (
                    <ArrowRight size={16} className="text-gray-400" />
                  )}
                ...
                <div className="text-center mb-2">
                  ...
                  <p className="text-xs text-gray-500 font-body mt-1">
                    ...
                    <strong className="text-[#333]">
                      {verifyMethod === "email" ? email : `+1 ${phone}`}
                    </strong>
                  </p>
                </div>
                  ...
                  {[0, 1, 2, 3, 4, 5].map(i => (
                    <input
                      ...
                      onChange={e => {
                        ...
                        if (!val && otpCode[i]) {
                          setOtpCode(
                            prev => prev.slice(0, i) + prev.slice(i + 1)
                          );
                          return;
                        }
                        if (!val) return;
                      ...
                      onKeyDown={e => {
                        if (e.key === "Backspace" && !otpCode[i] && i > 0) {
                          const prev = (e.target as HTMLElement).parentElement
                            ?.children[i - 1] as HTMLInputElement;
                          prev?.focus();
                ...
                <div className="text-center">
                  {countdown > 0 ? (
                    ...
                    <button
                      ...
                      className="text-xs text-[#4B2D8E] hover:underline font-body"
                    >
          ...
          <div className="text-center mt-6">
            <p className="text-white/40 text-xs font-body">
              By creating an account, you confirm you are 19 years of age or
