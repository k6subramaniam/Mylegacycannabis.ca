    ...
    <>
        ...
        <div className="container relative z-10 py-6 md:py-10">
          ...
          <div className="max-w-2xl">
            <h1 className="font-display text-4xl md:text-5xl text-white leading-tight mb-4">
              {t.about.ourLegacy} <span className="text-[#F15929]">{t.about.legacy}</span>
            </h1>
      ...
      <section className="bg-white py-12 md:py-16 -mt-1">
        <div className="container max-w-4xl">
          <div>
            <h2 className="font-display text-3xl text-[#4B2D8E] mb-6">{t.about.ourStory}</h2>
      ...
      <section className="bg-[#F5F5F5] py-12 md:py-16">
        <div className="container">
          <div className="text-center mb-10">
            <h2 className="font-display text-3xl text-[#4B2D8E] mb-3">{t.about.ourValues}</h2>
          </div>
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="container text-center">
          <h2 className="font-display text-3xl text-[#4B2D8E] mb-4">{t.about.visitUsToday}</h2>
          <p className="text-gray-600 font-body mb-6 max-w-lg mx-auto">{t.about.visitUsDesc}</p>
