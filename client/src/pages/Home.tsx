...
const HERO_IMG_SM = `${HERO_IMG}?w=600&q=75`;
const HERO_IMG_MD = `${HERO_IMG}?w=1024&q=80`;
const HERO_IMG_LG = HERO_IMG;
    ...
    <>
      ...
      >
        <div className="absolute inset-0">
          <img
            src={HERO_IMG_SM}
            srcSet={`${HERO_IMG_SM} 600w, ${HERO_IMG_MD} 1024w, ${HERO_IMG_LG} 1440w`}
            sizes="100vw"
