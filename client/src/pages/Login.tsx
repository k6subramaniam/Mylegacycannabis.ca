        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/60 font-body text-sm mt-1">
              Welcome back to My Legacy Cannabis
            </p>
          </div>
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-[#4B2D8E]/10 flex items-center justify-center group-hover:bg-[#4B2D8E] transition-colors">
                    <Mail
                      size={20}
                      className="text-[#4B2D8E] group-hover:text-white transition-colors"
                    />
                  </div>
                  ...
                  <ArrowRight
                    size={16}
                    className="ml-auto text-gray-400 group-hover:text-[#4B2D8E]"
                  />
                </button>
                ...
                <Link
                  href="/register"
                  className="block w-full text-center bg-[#4B2D8E] hover:bg-[#3a2270] text-white font-display text-sm py-3.5 rounded-full transition-all"
                >
                  CREATE ACCOUNT
                </Link>
              </div>
            ...
            {step === "identifier" && (
              <div className="space-y-4">
                ...
                <div className="text-center mb-2">
                  <div
                    className={`w-14 h-14 rounded-full mx-auto mb-3 flex items-center justify-center ${method === "email" ? "bg-[#4B2D8E]/10" : "bg-[#F15929]/10"}`}
                  >
                    {method === "email" ? (
                      <Mail size={24} className="text-[#4B2D8E]" />
                    ) : (
                      <Phone size={24} className="text-[#F15929]" />
                    )}
                  </div>
                ...
                <button
                  ...
                  className={`w-full py-3.5 rounded-full font-display text-sm text-white transition-all flex items-center justify-center gap-2 ${
                    method === "email"
                      ? "bg-[#4B2D8E] hover:bg-[#3a2270]"
                      : "bg-[#F15929] hover:bg-[#d94d22]"
            ...
            {step === "otp" && (
              <div className="space-y-4">
                ...
                <div className="text-center mb-2">
                  ...
                  <p className="text-xs text-gray-500 font-body mt-1">
                    Code sent to{" "}
                    <strong className="text-[#333]">{identifier}</strong>
                  </p>
                </div>
