...
export const ROUTE_SEO: Record<string, RouteSEO> = {
  ...
  "/complete-profile": {
    ...
    description:
      "Complete your My Legacy Cannabis profile to unlock all features.",
  ...
  "/cart": {
    ...
    description:
      "Review your cart and proceed to checkout at My Legacy Cannabis.",
    canonicalPath: "/cart",
    noindex: true,
  },
  "/checkout": {
...
export const SERVER_META_MAP: Record<
  string,
  { title: string; description: string }
> = {};
