...
describe("Data Library", () => {
  describe("calculatePointsEarned", () => {
    ...
    it("should floor the result for decimal subtotals", () => {
      expect(calculatePointsEarned(99.99)).toBe(
        Math.floor(99.99 * POINTS_PER_DOLLAR)
      );
      expect(calculatePointsEarned(100.01)).toBe(
        Math.floor(100.01 * POINTS_PER_DOLLAR)
      );
      expect(calculatePointsEarned(100.5)).toBe(
        Math.floor(100.5 * POINTS_PER_DOLLAR)
      );
    });
