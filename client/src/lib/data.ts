...
export const products: Product[] = [
  ...
  // EDIBLES
  { id: 'p13', name: 'Mixed Fruit Gummies', slug: 'mixed-fruit-gummies', category: 'Edibles', categorySlug: 'edibles', strainType: 'Hybrid', thc: '10mg/pack', price: 15, weight: '10 pieces', description: 'Delicious mixed fruit gummies infused with 10mg THC total (1mg per gummy). Perfect for micro-dosing or sharing. Flavors include strawberry, orange, grape, and lemon.', shortDescription: 'Mixed fruit gummies — 10mg THC total, 10 pieces.', flavor: 'Mixed Fruit', image: 'https://images.unsplash.com/photo-1551892374-ecf8754cf8b0?w=500&q=80', images: ['https://images.unsplash.com/photo-1551892374-ecf8754cf8b0?w=800&q=80'], inStock: true, featured: true, rating: 4.7, reviewCount: 201 },
  { id: 'p14', name: 'Sour Watermelon Gummies', slug: 'sour-watermelon-gummies', category: 'Edibles', categorySlug: 'edibles', strainType: 'Sativa', thc: '10mg/pack', price: 15, weight: '10 pieces', description: 'Sour watermelon flavored gummies with a tangy kick. 10mg THC total per pack. Sativa-dominant for an uplifting, creative experience.', shortDescription: 'Sour watermelon gummies — 10mg THC, uplifting sativa.', flavor: 'Sour Watermelon', image: 'https://images.unsplash.com/photo-1546548970-71785318a17b?w=500&q=80', images: ['https://images.unsplash.com/photo-1546548970-71785318a17b?w=800&q=80'], inStock: true, featured: false, isNew: true, rating: 4.8, reviewCount: 143 },
  { id: 'p15', name: 'Dark Chocolate Bar', slug: 'dark-chocolate-bar', category: 'Edibles', categorySlug: 'edibles', strainType: 'Indica', thc: '10mg/bar', price: 12, weight: '1 bar', description: 'Rich dark chocolate bar infused with 10mg THC. Divided into 10 squares for easy dosing. Made with premium Belgian chocolate and indica-dominant extract.', shortDescription: 'Dark chocolate bar — 10mg THC, 10 breakable squares.', flavor: 'Dark Chocolate', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=500&q=80', images: ['https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=800&q=80'], inStock: true, featured: false, rating: 4.5, reviewCount: 87 },
  { id: 'p16', name: 'THC Lemonade', slug: 'thc-lemonade', category: 'Edibles', categorySlug: 'edibles', strainType: 'Hybrid', thc: '10mg/bottle', price: 8, weight: '355ml', description: 'Refreshing cannabis-infused lemonade with 10mg THC per bottle. Crisp, tart, and perfectly balanced. Great for social occasions or a sunny afternoon.', shortDescription: 'Cannabis lemonade — 10mg THC, refreshing and crisp.', flavor: 'Lemonade', image: 'https://images.unsplash.com/photo-1551892374-ecf8754cf8b0?w=500&q=80', images: ['https://images.unsplash.com/photo-1551892374-ecf8754cf8b0?w=800&q=80'], inStock: true, featured: true, isNew: true, rating: 4.6, reviewCount: 65 },
  // VAPES
